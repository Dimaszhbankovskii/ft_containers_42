...
void	test_reverse_iterator_1()
{
	...
	std::cout << "intVector: ";
	for (std::vector<int>::reverse_iterator it = intVector.rbegin(); it != intVector.rend(); ++it)
		std::cout << *it << " ";
	std::cout << std::endl;
...
/*************************************************************************************************/
	...
	std::vector<int>::reverse_iterator	it5 = it1 + 3;
	std::vector<int>::reverse_iterator	it6 = it5 - 2;
...
/*************************************************************************************************/
	...
	std::vector<int>::const_reverse_iterator	cIt1, cIt2;
	...
	std::vector<int>::const_reverse_iterator	cIt3(cIt1);
	std::vector<int>::const_reverse_iterator	cIt4 = cIt1;
	...
	std::vector<int>::const_reverse_iterator	cIt5 = cIt1 + 3;
	std::vector<int>::const_reverse_iterator	cIt6 = cIt5 - 2;
	...
	std::vector<int>::const_reverse_iterator	cIt7 = 2 + cIt1;
...
/*************************************************************************************************/
	...
	std::vector<int>::const_reverse_iterator	it_to_cIt_1(it1);
	std::vector<int>::const_reverse_iterator	it_to_cIt_2 = it1;
