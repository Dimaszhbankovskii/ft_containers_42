...
void    test_list_1()
{
	std::list<int>  intList1(4);

	std::cout << "intList1.front() = " << intList1.front() << std::endl;
	std::cout << "intList1.back() = " << intList1.back() << std::endl;
	std::cout << "intList1.size() = " << intList1.size() << std::endl;

	intList1.push_front(10);
	intList1.push_back(-54);
...
// 	std::cout << BLUE << "$>> init   list<int> intList1" << NORMAL << std::endl;

// 	std::vector<int>::pointer	prt1 = intVector1.data();
// 	if (!prt1)
...
// 	std::vector<int>::pointer	prt2 = intVector2.data();
// 	if (!prt2)
...
// 	std::vector<int>	intVectorTmp1(2);
...
// 		std::vector<int>	intVectorTmp2(intVectorTmp1.end(), intVectorTmp1.begin());
// 	}
...
// 	std::vector<int>			intVector3(intVectorTmp1.begin(), intVectorTmp1.end());
// 	std::vector<int>::pointer	prt3 = intVector3.data();
// 	if (!prt3)
...
// 	std::vector<int>			intVector4(intVector3);
// 	std::vector<int>::pointer	prt4 = intVector4.data();
// 	if (!prt4)
...
// 	std::vector<int>	intVector5;

// 	intVector5 = intVector4;

// 	std::vector<int>::pointer	prt5 = intVector5.data();
// 	if (!prt5)
...
// 	std::vector<int>::pointer	prt6 = intVector5.data();
// 	if (!prt6)
