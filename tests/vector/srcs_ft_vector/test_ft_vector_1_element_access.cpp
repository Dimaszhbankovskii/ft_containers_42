...
void	test_vector_1_element_access()
{
	...
	ft::vector<int>::reference			refIntVector1 = intVector1.at(1);
	ft::vector<int>::const_reference	cRefIntVector1 = intVector1.at(1);

	ft::vector<int>::reference			refIntVector2 = intVector1[1];
	ft::vector<int>::const_reference	cRefIntVector2 = intVector1[1];

	ft::vector<int>::reference			refIntVector3 = intVector1.front();
	ft::vector<int>::const_reference	cRefIntVector3 = intVector1.front();

	ft::vector<int>::reference			refIntVector4 = intVector1.back();
	ft::vector<int>::const_reference	cRefIntVector4 = intVector1.back();

	ft::vector<int>::pointer			prtDataIntVector1 = intVector1.data();
	ft::vector<int>::const_pointer		cPrtDataIntVector1 = intVector1.data();
