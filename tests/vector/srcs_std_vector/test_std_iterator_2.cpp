...
void	test_iterator_2()
{
	...
	for (std::vector<Fixed>::iterator it = fixedVector.begin(); it != fixedVector.end(); ++it)
		std::cout << *it << " ";
	std::cout << std::endl;
...
/*************************************************************************************************/
	...
	std::vector<Fixed>::iterator	it1, it2;
	...
	std::vector<Fixed>::iterator	it3(it1);
	std::vector<Fixed>::iterator	it4 = it1;
	...
	std::vector<Fixed>::iterator	it5 = it1 + 3;
	std::vector<Fixed>::iterator	it6 = it5 - 2;
...
/*************************************************************************************************/
	...
	std::vector<Fixed>::const_iterator	cIt1, cIt2;

	cIt1 = fixedVector.begin();
	cIt2 = fixedVector.end() - 1;

	std::vector<Fixed>::const_iterator::iterator_type	cP = cIt1.base();
	...
	std::vector<Fixed>::const_iterator	cIt3(cIt1);
	std::vector<Fixed>::const_iterator	cIt4 = cIt1;
	...
	std::vector<Fixed>::const_iterator	cIt5 = cIt1 + 3;
	std::vector<Fixed>::const_iterator	cIt6 = cIt5 - 2;
	...
	std::vector<Fixed>::const_iterator	cIt7 = 2 + cIt1;
...
/*************************************************************************************************/
	...
	std::vector<Fixed>::const_iterator	it_to_cIt_1(it1);
	std::vector<Fixed>::const_iterator	it_to_cIt_2 = it1;
