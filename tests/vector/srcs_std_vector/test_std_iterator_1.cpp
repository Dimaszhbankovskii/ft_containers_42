...
/*************************************************************************************************/
	...
	std::vector<int>::const_iterator	cIt1, cIt2;

	cIt1 = intVector.begin();
	cIt2 = intVector.end() - 1;

	std::vector<int>::const_iterator::iterator_type	cP = cIt1.base();
	...
	std::vector<int>::const_iterator	cIt3(cIt1);
	std::vector<int>::const_iterator	cIt4 = cIt1;
	...
	std::vector<int>::const_iterator	cIt5 = cIt1 + 3;
	std::vector<int>::const_iterator	cIt6 = cIt5 - 2;
	...
	std::vector<int>::const_iterator	cIt7 = 2 + cIt1;
...
/*************************************************************************************************/
	...
	std::vector<int>::const_iterator	it_to_cIt_1(it1);
	std::vector<int>::const_iterator	it_to_cIt_2 = it1;
